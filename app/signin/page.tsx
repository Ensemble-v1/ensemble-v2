          ...
          <div className="card-brutalist">
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="w-5 h-5 border-3 border-black mr-3" />
                  <span className="font-inter text-sm">Remember me</span>
                </label>
                <Link href="/forgot-password" className="font-inter text-sm text-cyber-orange hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white font-inter text-gray-500">Or continue with</span>
                </div>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="font-inter text-gray-600">
                ...
                <Link href="/signup" className="text-cyber-orange font-semibold hover:underline">
                  Sign up here
                </Link>
              </p>
            </div>
